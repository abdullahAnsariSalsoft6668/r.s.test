                ...
                {type === 'logout' ? (
                    <>
                        <View style={styles.logoutIconWrap}>
                            <MyIcons name="fail" size={moderateScale(72)} />
                        </View>
                        {resolvedTitle ? <TextComp text={resolvedTitle} style={styles.logoutSheetTitle} /> : null}
                        {resolvedMessage ? (
                        ...
                        <View style={styles.logoutActionsRow}>
                            ...
                            <ButtonComp
                                ...
                                height={46}
                                style={styles.logoutActionButton}
                                textStyle={[styles.logoutNoText, { color: Colors.white }]}
                            />
                        </View>
                    </>
                ) : null}
