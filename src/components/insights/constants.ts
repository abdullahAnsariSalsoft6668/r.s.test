...
export const INSIGHT_STATS: InsightStatItem[] = [
    { id: '1', emoji: '💰', value: '$144.80', label: 'Total Saving (6 Mo)' },
    { id: '2', emoji: '⏱️', value: '4.7 Hrs', label: 'Time Saved' },
    { id: '3', emoji: '📅', value: '$24.40', label: 'This Month' },
    { id: '4', emoji: '🛒', value: '$5.36', label: 'Avg Per Trip' },
];
