...
const ExtraWorkFormField: React.FC<ExtraWorkFormFieldProps> = ({
    ...
    const inputAnimatedStyle = useAnimatedStyle(() => ({
        borderColor: hasError
            ? Colors.error
            : interpolateColor(focused.value, [0, 1], [Colors.gray100, Colors.secondary]),
        transform: [
        ...
        <Animated.View style={[styles.wrapper, containerStyle, animatedStyle]}>
            ...
            <Animated.View style={[styles.inputShell, inputContainerStyle, inputAnimatedStyle]}>
                ...
                <TextInput
                    ...
                    onFocus={event => {
                        focused.value = withSpring(1, { damping: 18, stiffness: 220 });
                        onFocus?.(event);
                    }}
                    onBlur={event => {
                        focused.value = withSpring(0, { damping: 18, stiffness: 220 });
                        onBlur?.(event);
                    }}
                    {...props}
                />
