    ...
    return (
        <Animated.View style={[styles.card, animatedStyle]}>
            <Pressable onPress={() => onPress?.(route)} disabled={!onPress}>
                ...
                {route.timeRange ? <RouteMetaRow icon="time" text={route.timeRange} /> : null}
                {route.path ? <RouteMetaRow icon="transaction" text={route.path} /> : null}
            ...
            <View style={styles.actionRow}>
                ...
                {route.status !== 'details' ? (
                    <Animated.View style={chevronScale}>
                        ...
                        >
                            <MyIcons name="rightArrow" size={moderateScale(16)} />
                        </Pressable>
                    </Animated.View>
                ) : null}
            </View>
