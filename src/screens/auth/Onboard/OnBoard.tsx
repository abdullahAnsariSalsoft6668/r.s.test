...
import OnboardingIconOrb from './OnboardingIconOrb';
import {
  COLLAGE_ORB_CONFIG,
  CollageOrbConfig,
      ...
      >
        <SafeAreaView style={styles.safe} edges={['top', 'left', 'right']}>
          <View style={styles.brandRow}>
            <TextComp text="RizqShare" style={styles.brand} />
            <TextComp
          ...
          <View style={[styles.bottomBlock, { paddingBottom: Math.max(insets.bottom, 70) }]}>
            <Animated.View style={titleStyle}>
              <TextComp text="Track Your Rizq Wisely" style={styles.title} />
            </Animated.View>
            <Animated.View style={descriptionStyle}>
              <TextComp
                text="Manage income, expenses, and donations — powered by AI insights."
            ...
            <Animated.View style={[styles.paginationContainer, dotsStyle]}>
